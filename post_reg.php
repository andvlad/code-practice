            ...
            if(isset($_POST["email"])){
                ...
                if(!empty($email)){
                    ...
                    if(!preg_match($reg_email, $email)==1){
                        // Сохраняем в сессию сообщение об ошибке. 
                        $_SESSION["error_messages"] .= "<p class='mesage_error' >Вы ввели неправельный e-mail</p>";
...
/*
            ...
            $result_query_insert = $mysqli->query("INSERT INTO `users_data` (`login`, `email`, `password`) VALUES ('".$login."', '".$email."', '".$password."')");
