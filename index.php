...
<?php require_once("slider.html"); ?>
    ...
    <div class="info">
      ...
      <div class="text">
        ...
        <a class="ref" href="https://ru.wikipedia.org/wiki/HTML">Wikipedia</a>
      </div>

      <div class="text">
        <a href="#img8"><img class="img1" src="https://upload.wikimedia.org/wikipedia/commons/2/27/PHP-logo.svg" class="img-right" alt="Логотип PHP"></a>
        <a href="#close" class="lightbox" id="img8"><img src="https://upload.wikimedia.org/wikipedia/commons/2/27/PHP-logo.svg"></a>
        ...
        <a class="ref" href="https://ru.wikipedia.org/wiki/CSS">Wikipedia</a>
      </div>
    </div>
